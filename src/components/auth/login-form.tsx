    ...
    <Card className="w-full max-w-md shadow-2xl border-none bg-white rounded-[3rem] overflow-hidden font-body">
      <CardHeader className="space-y-1 pb-6 text-center pt-12">
        <div className="flex justify-center mb-8">
          <div className="bg-white p-2 rounded-[2rem] shadow-xl border-4 border-slate-50">
            <Image src="/icon.png" alt="Logo" width={80} height={80} className="rounded-2xl" priority />
          </div>
        </div>
      ...
      <CardContent className="grid gap-6 px-10 pb-16">
        {serverError && (
          <Alert variant="destructive" className="rounded-2xl">
            ...
            <AlertDescription className="text-xs font-bold">{serverError}</AlertDescription>
          </Alert>
        )}
        <Form {...form}>
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    ...
                    <Input placeholder="example@hgu.jp" className="pl-14 h-14 rounded-[1.25rem] font-bold" {...field} />
                  </div>
                </FormControl>
                <FormMessage />
              </FormItem>
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    ...
                    <Input type="password" placeholder="••••••••" className="pl-14 h-14 rounded-[1.25rem] font-bold" {...field} />
                  </div>
                </FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <Button type="submit" className="w-full h-14 font-black text-lg rounded-[1.25rem] shadow-lg" disabled={isLoading}>
              {isLoading ? <><Loader2 className="mr-3 h-5 w-5 animate-spin" />認証中</> : "ログイン"}
            </Button>
          </form>
        </Form>
      </CardContent>
